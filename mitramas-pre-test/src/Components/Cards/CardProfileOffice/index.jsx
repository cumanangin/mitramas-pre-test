      ...
      <div className="bg-white rounded-2xl w-full mobile:h-full mobile:m-auto tablet:m-0 ">
        ...
        <div>
          <div className="mobile:flex mobile:flex-col pt-10">
            <span className="mobile:text-xs tablet:text-base pc:text-lg mobile:font-medium mobile:flex mobile:justify-center">
              Mitramas Infosys Global
            </span>
            <span className="mobile:flex mobile:justify-center font-light mobile:text-sm tablet:text-base pc:text-lg">
              Layanan IT
            </span>
            <span className="flex justify-center items-center text-[#5F9263] pt-2 mobile:text-sm tablet:text-base pc:text-lg">
              <BiEditAlt />
              Sunting Profil
            </span>
          </div>
          <div className="pt-5 flex-1 px-5 mobile:text-xs tablet:text-base pc:text-lg">
            <div>
